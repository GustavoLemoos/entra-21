...
namespace Entra21.ExemplosWindowsForms.Exemplo01
{
    public partial class PacientesForm : Form
    {
        ...
        {
            // Converter uma lista de objetos em uma string cotendo o JSON
            var pacientesEmJson = JsonConvert.SerializeObject(pacientes);
            var caminho = "pacientes.json";
            // Salvar a string contendo o JSON em um arquivo no formato JSONl
        ...
        private void LerAquivoApresentandoPacientes()
        {
            ...
            for (int i = 0; i < pacientes.Count; i++)
            {
                ...
                dataGridView1.Rows.Add(new object[]
                {
                    ...
                    paciente.Altura, paciente.Peso, CalcularImc(paciente.Peso, paciente.Altura)
                });
                // Rotina para descobrir o código com o maior
