...
namespace Entra21.ExemplosWindowsForms.Exemplo01
{
    internal class EnderecoServico
    {
        ...
        public void Editar(Endereco enderecoParaAlterar)
        {
            ...
            {
                // Obtén o endereço da lista de endereços
        ...
        {
            // Percorre a lista de edereços a fim de encontrar o endereço que deve ser removido
            for (int i = 0; i < enderecos.Count; i++)
            {
                ...
                {
                    // Remove o endereço encontrado da lsita de endereços
        ...
        {
            // Percorre a lista de endereços a fim de encontrar o endereço com o código desejado
            for (int i = 0; i < enderecos.Count; i++)
            {
                // Obtém o endereço percorrido
                var endereco = enderecos[i];
